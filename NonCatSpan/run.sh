...
python make_data.py -d ../datasets/data/test_seen -s ../datasets/data/schema.json -o task_data/test_seen.jsonl
python train.py --train_file task_data/test_seen.jsonl --model_name saved/large_val
