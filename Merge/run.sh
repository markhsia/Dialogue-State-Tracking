...
python ../CatChoice_WD/make_data.py -d ~/data/test_seen -s ~/data/schema.json -o cat_task_data/test_seen.jsonl --norm
python ../CatChoice_WD/predict.py --test_file cat_task_data/test_seen.jsonl --target_dir ../CatChoice_WD/saved/large_align_aug --out_file outputs/test_seen/cat_results.json
python ../NoncatSpan/make_data.py -d ~/data/test_seen -s ~/data/schema.json -o noncat_task_data/test_seen.jsonl --norm
...
python ../CatChoice_WD/make_data.py -d ~/data/test_unseen -s ~/data/schema.json -o cat_task_data/test_unseen.jsonl --norm
...
python ../NoncatSpan/make_data.py -d ~/data/test_unseen -s ~/data/schema.json -o noncat_task_data/test_unseen.jsonl --norm
