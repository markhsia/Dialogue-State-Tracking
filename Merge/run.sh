...
python ../CatChoice/predict.py --test_file cat_task_data/test_seen.jsonl --target_dir ../CatChoice/saved/0622-1024 --out_file outputs/test_seen/cat_results.json --test_batch_size 32
#python ../NoncatSpan/make_data.py -d ../datasets/data/test_seen -s ../datasets/data/schema.json -o noncat_task_data/test_seen.jsonl
python ../NoncatSpan/predict.py --test_file noncat_task_data/test_seen.jsonl --target_dir ../NoncatSpan/saved/0622-0807 --out_file outputs/test_seen/noncat_results.json --test_batch_size 32
...
#python ../CatChoice/predict.py --test_file cat_task_data/test_unseen.jsonl --target_dir ../CatChoice/saved/0622-1024 --out_file outputs/test_unseen/cat_results.json
...
#python ../NoncatSpan/predict.py --test_file noncat_task_data/test_unseen.jsonl --target_dir ../NoncatSpan/saved/0622-0807 --out_file outputs/test_unseen/noncat_results.json
